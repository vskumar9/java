...
public class SeriesApGFG {
	
	public static void seriesAp(int firstVal, int differ, int position)
	{
		System.out.println(firstVal+((position-1)*differ));
	}
	
	public static void main(String[] args) {
		
		int firstVal = new Scanner(System.in).nextInt();
		int secondVal = new Scanner(System.in).nextInt();
		int position = new Scanner(System.in).nextInt();
		
		seriesAp(firstVal, (secondVal-firstVal), position);
	}
}
/*
